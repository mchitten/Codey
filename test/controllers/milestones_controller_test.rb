...
class MilestonesControllerTest < ActionController::TestCase
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post :create, milestone: { project_id: @milestone.project_id, title: @milestone.title, version: @milestone.version }
    end
  ...
  test "should update milestone" do
    patch :update, id: @milestone, milestone: { project_id: @milestone.project_id, title: @milestone.title, version: @milestone.version }
    assert_redirected_to milestone_path(assigns(:milestone))
  end
